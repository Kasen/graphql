...
local find_expr_index = require('graphql.find_expr_index')
...
local function run_case(test, case)
    test:test(case.name or case.expr, function(test)
        ...
        local optimized_expr = find_expr_index.internal.propagate_constants(
        ...
        local optimized_expr_2 = find_expr_index.internal.propagate_constants(
            optimized_expr, context)
